...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            if (string.Equals(type, GradeBookType.Standard.ToString(), StringComparison.InvariantCultureIgnoreCase))
            {
                gradeBook = new StandardGradeBook(name, isWeighted);
            }
            else if (string.Equals(type, GradeBookType.Ranked.ToString(), StringComparison.InvariantCultureIgnoreCase))
            {
